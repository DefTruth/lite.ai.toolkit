...
This project will no longer be updated frequently. For a better deployment experience, please try [⚡️PaddlePaddle/FastDeploy](https://github.com/PaddlePaddle/FastDeploy). [⚡️FastDeploy](https://github.com/PaddlePaddle/FastDeploy) is an **Easy-to-use** and **High Performance** AI model deployment toolkit for Cloud, Mobile and Edge with 📦**out-of-the-box and unified experience**, 🔚**end-to-end optimization** for over **🔥150+ Text, Vision, Speech and Cross-modal AI models**. Including image classification, object detection, image segmentation, face detection, face recognition, keypoint detection, matting, OCR, NLP, TTS and other tasks to meet developers' industrial deployment needs for **multi-scenario**, **multi-hardware** and **multi-platform**.

| [Image Classification](https://github.com/PaddlePaddle/FastDeploy/tree/develop/examples/vision/classification)                                                                                         | [Object Detection](https://github.com/PaddlePaddle/FastDeploy/tree/develop/examples/vision/detection)                                                                                                  | [Semantic Segmentation](https://github.com/PaddlePaddle/FastDeploy/tree/develop/examples/vision/segmentation/paddleseg)                                                                                  | [Potrait Segmentation](https://github.com/PaddlePaddle/FastDeploy/tree/develop/examples/vision/segmentation/paddleseg)                                                                                                                                                                                                                                                                                                                                                             |
|:----------------------------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
...
| [**Image Matting**](https://github.com/PaddlePaddle/FastDeploy/tree/develop/examples/vision/matting)                                                                                                   | [**Real-Time Matting**](https://github.com/PaddlePaddle/FastDeploy/tree/develop/examples/vision/matting)                                                                                               | [**OCR**](https://github.com/PaddlePaddle/FastDeploy/tree/develop/examples/vision/ocr)                                                                                                                   | [**Face Alignment**](https://github.com/PaddlePaddle/FastDeploy/tree/develop/examples/vision/facealign)                                                                                                                                                                                                                                                                                                                                                                            |
...
| [**Pose Estimation**](https://github.com/PaddlePaddle/FastDeploy/tree/develop/examples/vision/keypointdetection)                                                                                       | [**Behavior Recognition**](https://github.com/PaddlePaddle/FastDeploy/issues/6)                                                                | [**NLP**](https://github.com/PaddlePaddle/FastDeploy/tree/develop/examples/text)                                                                                                                         | [**Speech**](https://github.com/PaddlePaddle/FastDeploy/tree/develop/examples/audio/pp-tts)                                                                                                                                                                                                                                                                                                                                                                                        |
