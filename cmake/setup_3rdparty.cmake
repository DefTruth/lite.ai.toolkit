...
if (EXISTS ${THIRDPARTY_DIR} AND LITE_AI_THIRDPARTY)
    ...
    if (ENABLE_ONNXRUNTIME)
        ...
        message(STATUS "ENABLE_ONNXRUNTIME: ON")
    endif()
    if (ENABLE_MNN)
        set(MNN_DIR ${THIRDPARTY_DIR}/${PLATFORM_NAME}/MNN/1.2.0/x86_64)
        ...
        message(STATUS "ENABLE_MNN: ON")
    endif()
    if (ENABLE_NCNN)
        set(NCNN_DIR ${THIRDPARTY_DIR}/${PLATFORM_NAME}/ncnn/1.0.21.10/x86_64)
