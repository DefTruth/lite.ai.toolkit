# How to convert ResNet to ONNX

## 1. 前言

这篇文档主要记录将项目[ResNet](https://pytorch.org/hub/pytorch_vision_resnet) 的模型转换成onnx模型.
...
def convert_static_resnet():
    import numpy as np

    onnx_path = "./weights/resnet18.onnx"
    sim_onnx_path = "./weights/resnet18-sim.onnx"
...
if __name__ == "__main__":
    convert_static_resnet()

    """
    PYTHONPATH=. python3 ./resnet.py
    """
