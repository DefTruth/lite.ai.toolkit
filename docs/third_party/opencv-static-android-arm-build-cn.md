...
## 1. 编译脚本  
 `build-opencv-static-android.sh`如下： 
...
popd  
```  
参考自[build-opencv3-static-android](https://github.com/DayBreak-u/chineseocr_lite/blob/onnx/android_projects/OcrLiteAndroidOnnx/scripts/build-opencv3-static-android.sh)