...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../hub/mnn/cv/densenet121.mnn";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_densenet.jpg";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../hub/ncnn/cv/densenet121.opt.param";
  std::string bin_path = "../../../hub/ncnn/cv/densenet121.opt.bin";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_densenet.jpg";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../hub/tnn/cv/densenet121.opt.tnnproto";
  std::string model_path = "../../../hub/tnn/cv/densenet121.opt.tnnmodel";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_densenet.jpg";
