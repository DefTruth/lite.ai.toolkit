...
static void test_default()
{
  ...
  std::string save_img_path = "../../../logs/test_lite_emotion8.jpg";
...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../hub/mnn/cv/face-emotion-recognition-enet_b0_8_best_afew.mnn";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_emotion.jpg";
  std::string save_img_path = "../../../logs/test_lite_emotion8_mnn.jpg";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../hub/ncnn/cv/face-emotion-recognition-enet_b0_8_best_afew.opt.param";
  std::string bin_path = "../../../hub/ncnn/cv/face-emotion-recognition-enet_b0_8_best_afew.opt.bin";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_emotion.jpg";
  std::string save_img_path = "../../../logs/test_lite_emotion8_ncnn.jpg";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../hub/tnn/cv/face-emotion-recognition-enet_b0_8_best_afew.opt.tnnproto";
  std::string model_path = "../../../hub/tnn/cv/face-emotion-recognition-enet_b0_8_best_afew.opt.tnnmodel";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_emotion.jpg";
  std::string save_img_path = "../../../logs/test_lite_emotion8_tnn.jpg";
