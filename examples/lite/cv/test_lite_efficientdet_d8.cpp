...
{
  std::string onnx_path = "../../../hub/onnx/cv/efficientdet-d8.onnx";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_detection_1.jpg";
  std::string save_img_path = "../../../logs/test_lite_efficientdet_d8_1.jpg";
...
static void test_onnxruntime()
{
  ...
  std::string save_img_path = "../../../logs/test_onnx_efficientdet_d8_2.jpg";
