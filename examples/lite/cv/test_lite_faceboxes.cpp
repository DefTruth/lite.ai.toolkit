...
{
  std::string onnx_path = "../../../examples/hub/onnx/cv/FaceBoxes.onnx";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_detector.jpg";
  std::string save_img_path = "../../../examples/logs/test_lite_faceboxes.jpg";
...
static void test_onnxruntime()
{
  ...
  std::string save_img_path = "../../../examples/logs/test_faceboxes_onnx_2.jpg";
...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../examples/hub/mnn/cv/FaceBoxes.mnn";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_detector_2.jpg";
  std::string save_img_path = "../../../examples/logs/test_faceboxes_mnn_2.jpg";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../examples/hub/ncnn/cv/FaceBoxes.opt.param";
  std::string bin_path = "../../../examples/hub/ncnn/cv/FaceBoxes.opt.bin";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_detector_2.jpg";
  std::string save_img_path = "../../../examples/logs/test_faceboxes_ncnn_2.jpg";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../examples/hub/tnn/cv/FaceBoxes.opt.tnnproto";
  std::string model_path = "../../../examples/hub/tnn/cv/FaceBoxes.opt.tnnmodel";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_detector_2.jpg";
  std::string save_img_path = "../../../examples/logs/test_faceboxes_tnn_2.jpg";
