...
static void test_default()
{
  ...
  lite::cv::face::align::FaceMesh *facemesh =
      new lite::cv::face::align::FaceMesh(onnx_path);
...
static void test_onnxruntime()
{
  ...
  lite::onnxruntime::cv::face::align::FaceMesh *facemesh =
      new lite::onnxruntime::cv::face::align::FaceMesh(onnx_path);
...
static void test_mnn()
{
  ...
  lite::mnn::cv::face::align::FaceMesh *facemesh =
      new lite::mnn::cv::face::align::FaceMesh(mnn_path);
