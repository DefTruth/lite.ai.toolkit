...
{
  std::string onnx_path = "../../../examples/hub/onnx/cv/fcn_resnet101.onnx";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_fcn_resnet101.png";
  std::string save_img_path = "../../../examples/logs/test_lite_fcn_resnet101.jpg";
...
static void test_onnxruntime()
{
  ...
  std::string onnx_path = "../../../examples/hub/onnx/cv/fcn_resnet101.onnx";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_fcn_resnet101.png";
  std::string save_img_path = "../../../examples/logs/test_onnx_fcn_resnet101.jpg";
...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../examples/hub/mnn/cv/fcn_resnet101.mnn";
  // std::string mnn_path = "../../../examples/hub/mnn/cv/fcn_resnet101.opt.mnn";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_fcn_resnet101.png";
  std::string save_img_path = "../../../examples/logs/test_fcn_resnet101_mnn.jpg";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../examples/hub/ncnn/cv/fcn_resnet101.opt.param";
  std::string bin_path = "../../../examples/hub/ncnn/cv/fcn_resnet101.opt.bin";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_fcn_resnet101.png";
  std::string save_img_path = "../../../examples/logs/test_fcn_resnet101_ncnn.jpg";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../examples/hub/tnn/cv/fcn_resnet101.opt.tnnproto";
  std::string model_path = "../../../examples/hub/tnn/cv/fcn_resnet101.opt.tnnmodel";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_fcn_resnet101.png";
  std::string save_img_path = "../../../examples/logs/test_fcn_resnet101_tnn.jpg";
