...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../hub/mnn/cv/focal-arcface-bh-ir50-asia.mnn";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_focal_asia_arcface_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_focal_asia_arcface_2.png";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../hub/ncnn/cv/focal-arcface-bh-ir50-asia.opt.param";
  std::string bin_path = "../../../hub/ncnn/cv/focal-arcface-bh-ir50-asia.opt.bin";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_focal_asia_arcface_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_focal_asia_arcface_2.png";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../hub/tnn/cv/focal-arcface-bh-ir50-asia.opt.tnnproto";
  std::string model_path = "../../../hub/tnn/cv/focal-arcface-bh-ir50-asia.opt.tnnmodel";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_focal_asia_arcface_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_focal_asia_arcface_2.png";
