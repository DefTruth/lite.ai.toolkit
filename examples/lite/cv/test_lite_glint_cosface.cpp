...
{
  std::string onnx_path = "../../../examples/hub/onnx/cv/glint360k_cosface_r100.onnx";
...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../examples/hub/mnn/cv/glint360k_cosface_r100.mnn";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_glint_cosface_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_glint_cosface_2.png";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../examples/hub/ncnn/cv/glint360k_cosface_r100.opt.param";
  std::string bin_path = "../../../examples/hub/ncnn/cv/glint360k_cosface_r100.opt.bin";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../examples/hub/tnn/cv/glint360k_cosface_r100.opt.tnnproto";
  std::string model_path = "../../../examples/hub/tnn/cv/glint360k_cosface_r100.opt.tnnmodel";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_faceid_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_faceid_2.png";
