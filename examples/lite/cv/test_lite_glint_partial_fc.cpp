...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../hub/mnn/cv/partial_fc_glint360k_r50.mnn";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_glint_partial_fc_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_glint_partial_fc_2.png";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../hub/ncnn/cv/partial_fc_glint360k_r50.opt.param";
  std::string bin_path = "../../../hub/ncnn/cv/partial_fc_glint360k_r50.opt.bin";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../hub/tnn/cv/partial_fc_glint360k_r50.opt.tnnproto";
  std::string model_path = "../../../hub/tnn/cv/partial_fc_glint360k_r50.opt.tnnmodel";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_faceid_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_faceid_2.png";
