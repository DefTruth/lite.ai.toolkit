...
{
  std::string onnx_path = "../../../examples/hub/onnx/cv/hardnet.onnx";
...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../examples/hub/mnn/cv/hardnet.mnn";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_hardnet.jpg";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../examples/hub/ncnn/cv/hardnet.opt.param";
  std::string bin_path = "../../../examples/hub/ncnn/cv/hardnet.opt.bin";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_hardnet.jpg";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../examples/hub/tnn/cv/hardnet.opt.tnnproto";
  std::string model_path = "../../../examples/hub/tnn/cv/hardnet.opt.tnnmodel";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_hardnet.jpg";
