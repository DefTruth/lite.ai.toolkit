...
{
  std::string onnx_path = "../../../examples/hub/onnx/cv/ibnnet18.onnx";
...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../examples/hub/mnn/cv/ibnnet18.mnn";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_ibnnet.jpg";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../examples/hub/ncnn/cv/ibnnet18.opt.param";
  std::string bin_path = "../../../examples/hub/ncnn/cv/ibnnet18.opt.bin";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_ibnnet.jpg";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../examples/hub/tnn/cv/ibnnet18.opt.tnnproto";
  std::string model_path = "../../../examples/hub/tnn/cv/ibnnet18.opt.tnnmodel";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_ibnnet.jpg";
