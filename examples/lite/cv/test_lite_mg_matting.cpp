...
static void test_default()
{
  ...
  std::string save_fgr_path = "../../../logs/test_lite_mg_matting_fgr.jpg";
  std::string save_pha_path = "../../../logs/test_lite_mg_matting_pha.jpg";
  std::string save_merge_path = "../../../logs/test_lite_mg_matting_merge.jpg";
...
static void test_onnxruntime()
{
  ...
  std::string test_img_path = "../../../examples/lite/resources/test_lite_mg_matting_input.jpg";
  std::string test_mask_path = "../../../examples/lite/resources/test_lite_mg_matting_mask.png";
  std::string save_fgr_path = "../../../logs/test_lite_mg_matting_fgr_onnx.jpg";
  std::string save_pha_path = "../../../logs/test_lite_mg_matting_pha_onnx.jpg";
  std::string save_merge_path = "../../../logs/test_lite_mg_matting_merge_onnx.jpg";
...
static void test_mnn()
{
  ...
  std::string test_img_path = "../../../examples/lite/resources/test_lite_mg_matting_input.jpg";
  std::string test_mask_path = "../../../examples/lite/resources/test_lite_mg_matting_mask.png";
  std::string save_fgr_path = "../../../logs/test_lite_mg_matting_fgr_mnn.jpg";
  std::string save_pha_path = "../../../logs/test_lite_mg_matting_pha_mnn.jpg";
  std::string save_merge_path = "../../../logs/test_lite_mg_matting_merge_mnn.jpg";
...
static void test_tnn()
{
  ...
  std::string test_img_path = "../../../examples/lite/resources/test_lite_mg_matting_input.jpg";
  std::string test_mask_path = "../../../examples/lite/resources/test_lite_mg_matting_mask.png";
  std::string save_fgr_path = "../../../logs/test_lite_mg_matting_fgr_tnn.jpg";
  std::string save_pha_path = "../../../logs/test_lite_mg_matting_pha_tnn.jpg";
  std::string save_merge_path = "../../../logs/test_lite_mg_matting_merge_tnn.jpg";
