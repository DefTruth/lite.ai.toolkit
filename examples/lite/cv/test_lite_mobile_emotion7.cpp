...
{
  std::string onnx_path = "../../../hub/onnx/cv/face-emotion-recognition-mobilenet_7.onnx";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_emotion.jpg";
  std::string save_img_path = "../../../logs/test_lite_mobile_emotion7.jpg";
...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../hub/mnn/cv/face-emotion-recognition-mobilenet_7.mnn";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_emotion.jpg";
  std::string save_img_path = "../../../logs/test_lite_mobile_emotion7_mnn.jpg";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../hub/ncnn/cv/face-emotion-recognition-mobilenet_7.opt.param";
  std::string bin_path = "../../../hub/ncnn/cv/face-emotion-recognition-mobilenet_7.opt.bin";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_emotion.jpg";
  std::string save_img_path = "../../../logs/test_lite_mobile_emotion7_ncnn.jpg";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../hub/tnn/cv/face-emotion-recognition-mobilenet_7.opt.tnnproto";
  std::string model_path = "../../../hub/tnn/cv/face-emotion-recognition-mobilenet_7.opt.tnnmodel";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_emotion.jpg";
  std::string save_img_path = "../../../logs/test_lite_mobile_emotion7_tnn.jpg";
