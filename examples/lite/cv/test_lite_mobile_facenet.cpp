...
{
  std::string onnx_path = "../../../hub/onnx/cv/MobileFaceNet_Pytorch_068.onnx";
...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../hub/mnn/cv/MobileFaceNet_Pytorch_068.mnn";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_faceid_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_faceid_2.png";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../hub/ncnn/cv/MobileFaceNet_Pytorch_068.opt.param";
  std::string bin_path = "../../../hub/ncnn/cv/MobileFaceNet_Pytorch_068.opt.bin";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_faceid_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_faceid_2.png";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../hub/tnn/cv/MobileFaceNet_Pytorch_068.opt.tnnproto";
  std::string model_path = "../../../hub/tnn/cv/MobileFaceNet_Pytorch_068.opt.tnnmodel";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_faceid_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_faceid_2.png";
