...
{
  std::string onnx_path = "../../../examples/hub/onnx/cv/mobilenetv2.onnx";
...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../examples/hub/mnn/cv/mobilenetv2.mnn";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_mobilenetv2.jpg";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../examples/hub/ncnn/cv/mobilenetv2.opt.param";
  std::string bin_path = "../../../examples/hub/ncnn/cv/mobilenetv2.opt.bin";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_mobilenetv2.jpg";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../examples/hub/tnn/cv/mobilenetv2.opt.tnnproto";
  std::string model_path = "../../../examples/hub/tnn/cv/mobilenetv2.opt.tnnmodel";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_mobilenetv2.jpg";
