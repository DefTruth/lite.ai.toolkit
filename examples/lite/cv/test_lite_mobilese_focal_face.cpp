...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../hub/mnn/cv/face_recognition.pytorch_Mobilenet_se_focal_121000.mnn";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_faceid_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_faceid_2.png";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../hub/tnn/cv/face_recognition.pytorch_Mobilenet_se_focal_121000.opt.tnnproto";
  std::string model_path = "../../../hub/tnn/cv/face_recognition.pytorch_Mobilenet_se_focal_121000.opt.tnnmodel";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_faceid_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_faceid_2.png";
