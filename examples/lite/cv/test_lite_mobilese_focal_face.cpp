...
{
  std::string onnx_path = "../../../examples/hub/onnx/cv/face_recognition.pytorch_Mobilenet_se_focal_121000.onnx";
...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../examples/hub/mnn/cv/face_recognition.pytorch_Mobilenet_se_focal_121000.mnn";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_faceid_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_faceid_2.png";

  lite::mnn::cv::faceid::MobileSEFocalFace *mobilese_focal_face =
      new lite::mnn::cv::faceid::MobileSEFocalFace(mnn_path);
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../examples/hub/ncnn/cv/face_recognition.pytorch_Mobilenet_se_focal_121000.opt.param";
  std::string bin_path = "../../../examples/hub/ncnn/cv/face_recognition.pytorch_Mobilenet_se_focal_121000.opt.bin";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_faceid_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_faceid_2.png";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../examples/hub/tnn/cv/face_recognition.pytorch_Mobilenet_se_focal_121000.opt.tnnproto";
  std::string model_path = "../../../examples/hub/tnn/cv/face_recognition.pytorch_Mobilenet_se_focal_121000.opt.tnnmodel";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_faceid_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_faceid_2.png";

  lite::tnn::cv::faceid::MobileSEFocalFace *mobilese_focal_face =
      new lite::tnn::cv::faceid::MobileSEFocalFace(proto_path, model_path);
