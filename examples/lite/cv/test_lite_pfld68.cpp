...
static void test_default()
{
  ...
  std::string save_img_path = "../../../examples/logs/test_lite_pfld68.jpg";
...
static void test_onnxruntime()
{
  ...
  std::string onnx_path = "../../../examples/hub/onnx/cv/pytorch_face_landmarks_pfld.onnx";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_landmarks.png";
  std::string save_img_path = "../../../examples/logs/test_pfld68_onnx.jpg";
...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../examples/hub/mnn/cv/pytorch_face_landmarks_pfld.mnn";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_landmarks.png";
  std::string save_img_path = "../../../examples/logs/test_pfld68_mnn.jpg";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../examples/hub/ncnn/cv/pytorch_face_landmarks_pfld.opt.param";
  std::string bin_path = "../../../examples/hub/ncnn/cv/pytorch_face_landmarks_pfld.opt.bin";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_landmarks.png";
  std::string save_img_path = "../../../examples/logs/test_pfld68_ncnn.jpg";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../examples/hub/tnn/cv/pytorch_face_landmarks_pfld.opt.tnnproto";
  std::string model_path = "../../../examples/hub/tnn/cv/pytorch_face_landmarks_pfld.opt.tnnmodel";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_landmarks.png";
  std::string save_img_path = "../../../examples/logs/test_pfld68_tnn.jpg";
