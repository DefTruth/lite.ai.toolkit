...
static void test_default()
{
  ...
  std::string save_img_path = "../../../examples/logs/test_lite_pfld98.jpg";
...
static void test_onnxruntime()
{
  ...
  std::string onnx_path = "../../../examples/hub/onnx/cv/PFLD-pytorch-pfld.onnx";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_landmarks.png";
  std::string save_img_path = "../../../examples/logs/test_pfld98_onnx.jpg";
...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../examples/hub/mnn/cv/PFLD-pytorch-pfld.mnn";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_landmarks.png";
  std::string save_img_path = "../../../examples/logs/test_pfld98_mnn.jpg";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../examples/hub/ncnn/cv/PFLD-pytorch-pfld.opt.param";
  std::string bin_path = "../../../examples/hub/ncnn/cv/PFLD-pytorch-pfld.opt.bin";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_landmarks.png";
  std::string save_img_path = "../../../examples/logs/test_pfld98_ncnn.jpg";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../examples/hub/tnn/cv/PFLD-pytorch-pfld.opt.tnnproto";
  std::string model_path = "../../../examples/hub/tnn/cv/PFLD-pytorch-pfld.opt.tnnmodel";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_landmarks.png";
  std::string save_img_path = "../../../examples/logs/test_pfld98_tnn.jpg";
