...
{
  std::string onnx_path = "../../../hub/onnx/cv/pipnet_resnet18_10x68x32x256_300w.onnx";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_align.png";
  std::string save_img_path = "../../../logs/test_lite_pipnet68.jpg";
...
static void test_onnxruntime()
{
  ...
  std::string onnx_path = "../../../hub/onnx/cv/pipnet_resnet18_10x68x32x256_300w.onnx";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_align.png";
  std::string save_img_path = "../../../logs/test_lite_pipnet68_onnx.jpg";
...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../hub/mnn/cv/pipnet_resnet18_10x68x32x256_300w.mnn";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_align.png";
  std::string save_img_path = "../../../logs/test_lite_pipnet68_mnn.jpg";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../hub/ncnn/cv/pipnet_resnet18_10x68x32x256_300w.opt.param";
  std::string bin_path = "../../../hub/ncnn/cv/pipnet_resnet18_10x68x32x256_300w.opt.bin";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_align.png";
  std::string save_img_path = "../../../logs/test_lite_pipnet68_ncnn.jpg";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../hub/tnn/cv/pipnet_resnet18_10x68x32x256_300w.opt.tnnproto";
  std::string model_path = "../../../hub/tnn/cv/pipnet_resnet18_10x68x32x256_300w.opt.tnnmodel";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_align.png";
  std::string save_img_path = "../../../logs/test_lite_pipnet68_tnn.jpg";
