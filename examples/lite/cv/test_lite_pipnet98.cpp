...
{
  std::string onnx_path = "../../../examples/hub/onnx/cv/pipnet_resnet18_10x98x32x256_wflw.onnx";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_align.png";
  std::string save_img_path = "../../../examples/logs/test_lite_pipnet98.jpg";
...
static void test_onnxruntime()
{
  ...
  std::string onnx_path = "../../../examples/hub/onnx/cv/pipnet_resnet18_10x98x32x256_wflw.onnx";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_align.png";
  std::string save_img_path = "../../../examples/logs/test_lite_pipnet98_onnx.jpg";
...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../examples/hub/mnn/cv/pipnet_resnet18_10x98x32x256_wflw.mnn";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_align.png";
  std::string save_img_path = "../../../examples/logs/test_lite_pipnet98_mnn.jpg";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../examples/hub/ncnn/cv/pipnet_resnet18_10x98x32x256_wflw.opt.param";
  std::string bin_path = "../../../examples/hub/ncnn/cv/pipnet_resnet18_10x98x32x256_wflw.opt.bin";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_align.png";
  std::string save_img_path = "../../../examples/logs/test_lite_pipnet98_ncnn.jpg";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../examples/hub/tnn/cv/pipnet_resnet18_10x98x32x256_wflw.opt.tnnproto";
  std::string model_path = "../../../examples/hub/tnn/cv/pipnet_resnet18_10x98x32x256_wflw.opt.tnnmodel";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_face_align.png";
  std::string save_img_path = "../../../examples/logs/test_lite_pipnet98_tnn.jpg";
