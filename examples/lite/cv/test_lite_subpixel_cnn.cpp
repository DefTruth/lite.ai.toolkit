...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../hub/mnn/cv/subpixel-cnn.mnn";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_subpixel_cnn.jpg";
  std::string save_img_path = "../../../logs/test_subpixel_cnn_mnn.jpg";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../hub/ncnn/cv/subpixel-cnn.opt.param";
  std::string bin_path = "../../../hub/ncnn/cv/subpixel-cnn.opt.bin";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_subpixel_cnn.jpg";
  std::string save_img_path = "../../../logs/test_subpixel_cnn_ncnn.jpg";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../hub/tnn/cv/subpixel-cnn.opt.tnnproto";
  std::string model_path = "../../../hub/tnn/cv/subpixel-cnn.opt.tnnmodel";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_subpixel_cnn.jpg";
  std::string save_img_path = "../../../logs/test_subpixel_cnn_tnn.jpg";
