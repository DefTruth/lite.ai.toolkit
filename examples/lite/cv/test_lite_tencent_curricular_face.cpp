...
{
#ifdef ENABLE_MNN
  std::string mnn_path = "../../../hub/mnn/cv/Tencent_CurricularFace_Backbone.mnn";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_faceid_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_faceid_2.png";
...
{
#ifdef ENABLE_NCNN
  std::string param_path = "../../../hub/ncnn/cv/Tencent_CurricularFace_Backbone.opt.param";
  std::string bin_path = "../../../hub/ncnn/cv/Tencent_CurricularFace_Backbone.opt.bin";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_faceid_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_faceid_2.png";
...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../hub/tnn/cv/Tencent_CurricularFace_Backbone.opt.tnnproto";
  std::string model_path = "../../../hub/tnn/cv/Tencent_CurricularFace_Backbone.opt.tnnmodel";
  std::string test_img_path0 = "../../../examples/lite/resources/test_lite_faceid_0.png";
  std::string test_img_path1 = "../../../examples/lite/resources/test_lite_faceid_2.png";
