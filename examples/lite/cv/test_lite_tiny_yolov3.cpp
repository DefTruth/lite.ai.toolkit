...
{
  std::string onnx_path = "../../../examples/hub/onnx/cv/tiny-yolov3-11.onnx";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_tiny_yolov3.jpg";
  std::string save_img_path = "../../../examples/logs/test_lite_tiny_yolov3.jpg";
...
static void test_onnxruntime()
{
  ...
  std::string onnx_path = "../../../examples/hub/onnx/cv/tiny-yolov3-11.onnx";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_tiny_yolov3.jpg";
  std::string save_img_path = "../../../examples/logs/test_onnx_tiny_yolov3.jpg";
