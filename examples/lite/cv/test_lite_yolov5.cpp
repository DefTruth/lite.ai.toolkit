...
{
#ifdef ENABLE_TNN
  std::string proto_path = "../../../hub/tnn/cv/yolov5s.opt.tnnproto";
  std::string model_path = "../../../hub/tnn/cv/yolov5s.opt.tnnmodel";
  std::string test_img_path = "../../../examples/lite/resources/test_lite_yolov5_2.jpg";
  std::string save_img_path = "../../../logs/test_lite_yolov5_2_tnn.jpg";
