...
// 检测并绘制检测框
void draw_bboxes(cv::Mat& image, const std::vector<lite::types::Bbox>& bboxes) {
...
static void test_default()
{
    ...
    std::string save_img_path = "Lite-Face-Detect.jpg";
    ...
    yolov8Face->detect(img_bgr, detected_boxes);

    draw_bboxes(img_bgr,detected_boxes);
