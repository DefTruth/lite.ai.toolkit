...
message(">>>> Current project is [ortcv_arcface_resnet] in : ${CMAKE_CURRENT_SOURCE_DIR}")
...
target_link_libraries(ortcv_arcface_resnet onnxruntime ${OpenCV_LIBS})
...
if (LITEHUB_COPY_BUILD)
    ...
    message("=================================================================================")
    message("output binary [app: ortcv_arcface_resnet] to ${EXECUTABLE_OUTPUT_PATH}")
    message("=================================================================================")
endif ()