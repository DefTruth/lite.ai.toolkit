...
message(">>>> Current project is [ortcv_deeplabv3_resnet101] in : ${CMAKE_CURRENT_SOURCE_DIR}")
...
set(ORTCV_DEEPLABV3_RESNET101_SRCS
        cv/test_ortcv_deeplabv3_resnet101.cpp
        ${LITEHUB_ROOT_DIR}/ort/cv/deeplabv3_resnet101.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_utils.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_handler.cpp
        )

add_executable(ortcv_deeplabv3_resnet101 ${ORTCV_DEEPLABV3_RESNET101_SRCS})
target_link_libraries(ortcv_deeplabv3_resnet101 onnxruntime ${OpenCV_LIBS})
...
if (LITEHUB_COPY_BUILD)
    ...
    message("=================================================================================")
    message("output binary [app: ortcv_deeplabv3_resnet101] to ${EXECUTABLE_OUTPUT_PATH}")
    message("=================================================================================")
endif ()