...
message(">>>> Current project is [ortcv_densenet] in : ${CMAKE_CURRENT_SOURCE_DIR}")
...
set(ORTCV_DENSENET_SRCS
        cv/test_ortcv_densenet.cpp
        ${LITEHUB_ROOT_DIR}/ort/cv/densenet.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_utils.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_handler.cpp
        )

add_executable(ortcv_densenet ${ORTCV_DENSENET_SRCS})
target_link_libraries(ortcv_densenet onnxruntime ${OpenCV_LIBS})
...
if (LITEHUB_COPY_BUILD)
    ...
    message("=================================================================================")
    message("output binary [app: ortcv_densenet] to ${EXECUTABLE_OUTPUT_PATH}")
    message("=================================================================================")
endif ()