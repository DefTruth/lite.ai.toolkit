...
message(">>>> Current project is [ortcv_fcn_resnet101] in : ${CMAKE_CURRENT_SOURCE_DIR}")
...
set(ORTCV_FCN_RESNET101_SRCS
        cv/test_ortcv_fcn_resnet101.cpp
        ${LITEHUB_ROOT_DIR}/ort/cv/fcn_resnet101.cpp
...
if (LITEHUB_COPY_BUILD)
    ...
    message("=================================================================================")
    message("output binary [app: ortcv_fcn_resnet101] to ${EXECUTABLE_OUTPUT_PATH}")
    message("=================================================================================")
endif ()