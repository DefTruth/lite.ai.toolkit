...
message(">>>> Current project is [ortcv_hardnet] in : ${CMAKE_CURRENT_SOURCE_DIR}")
...
set(ORTCV_HARDNET_SRCS
        cv/test_ortcv_hardnet.cpp
        ${LITEHUB_ROOT_DIR}/ort/cv/hardnet.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_utils.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_handler.cpp
        )

add_executable(ortcv_hardnet ${ORTCV_HARDNET_SRCS})
target_link_libraries(ortcv_hardnet onnxruntime ${OpenCV_LIBS})
...
if (LITEHUB_COPY_BUILD)
    ...
    message("=================================================================================")
    message("output binary [app: ortcv_hardnet] to ${EXECUTABLE_OUTPUT_PATH}")
    message("=================================================================================")
endif ()