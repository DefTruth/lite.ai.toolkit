...
message(">>>> Current project is [ortcv_ibnnet] in : ${CMAKE_CURRENT_SOURCE_DIR}")
...
set(ORTCV_IBNNET_SRCS
        cv/test_ortcv_ibnnet.cpp
        ${LITEHUB_ROOT_DIR}/ort/cv/ibnnet.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_utils.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_handler.cpp
        )

add_executable(ortcv_ibnnet ${ORTCV_IBNNET_SRCS})
target_link_libraries(ortcv_ibnnet onnxruntime ${OpenCV_LIBS})
...
if (LITEHUB_COPY_BUILD)
    ...
    message("=================================================================================")
    message("output binary [app: ortcv_ibnnet] to ${EXECUTABLE_OUTPUT_PATH}")
    message("=================================================================================")
endif ()