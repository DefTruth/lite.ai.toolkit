...
message(">>>> Current project is [ortcv_mobilenetv2] in : ${CMAKE_CURRENT_SOURCE_DIR}")
...
set(ORTCV_MOBILENETV2_SRCS
        cv/test_ortcv_mobilenetv2.cpp
        ${LITEHUB_ROOT_DIR}/ort/cv/mobilenetv2.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_utils.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_handler.cpp
        )

add_executable(ortcv_mobilenetv2 ${ORTCV_MOBILENETV2_SRCS})
target_link_libraries(ortcv_mobilenetv2 onnxruntime ${OpenCV_LIBS})
...
if (LITEHUB_COPY_BUILD)
    ...
    message("=================================================================================")
    message("output binary [app: ortcv_mobilenetv2] to ${EXECUTABLE_OUTPUT_PATH}")
    message("=================================================================================")
endif ()