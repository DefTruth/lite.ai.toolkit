...
message(">>>> Current project is [ortcv_pfld] in : ${CMAKE_CURRENT_SOURCE_DIR}")
...
set(ORTCV_PFLD_SRCS
        cv/test_ortcv_pfld.cpp
        ${LITEHUB_ROOT_DIR}/ort/cv/pfld.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_utils.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_handler.cpp
        )

add_executable(ortcv_pfld ${ORTCV_PFLD_SRCS})
target_link_libraries(ortcv_pfld onnxruntime ${OpenCV_LIBS})
...
if (LITEHUB_COPY_BUILD)
    ...
    message("=================================================================================")
    message("output binary [app: ortcv_pfld] to ${EXECUTABLE_OUTPUT_PATH}")
    message("=================================================================================")
endif ()