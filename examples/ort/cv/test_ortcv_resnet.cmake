...
message(">>>> Current project is [ortcv_resnet] in : ${CMAKE_CURRENT_SOURCE_DIR}")
...
set(ORTCV_RESNET_SRCS
        cv/test_ortcv_resnet.cpp
        ${LITEHUB_ROOT_DIR}/ort/cv/resnet.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_utils.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_handler.cpp
        )

add_executable(ortcv_resnet ${ORTCV_RESNET_SRCS})
target_link_libraries(ortcv_resnet onnxruntime ${OpenCV_LIBS})
...
if (LITEHUB_COPY_BUILD)
    ...
    message("=================================================================================")
    message("output binary [app: ortcv_resnet] to ${EXECUTABLE_OUTPUT_PATH}")
    message("=================================================================================")
endif ()