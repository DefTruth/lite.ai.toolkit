...
message(">>>> Current project is [ortcv_shufflenetv2] in : ${CMAKE_CURRENT_SOURCE_DIR}")
...
set(ORTCV_SHUFFLENETV2_SRCS
        cv/test_ortcv_shufflenetv2.cpp
        ${LITEHUB_ROOT_DIR}/ort/cv/shufflenetv2.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_utils.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_handler.cpp
        )

add_executable(ortcv_shufflenetv2 ${ORTCV_SHUFFLENETV2_SRCS})
target_link_libraries(ortcv_shufflenetv2 onnxruntime ${OpenCV_LIBS})
...
if (LITEHUB_COPY_BUILD)
    ...
    message("=================================================================================")
    message("output binary [app: ortcv_shufflenetv2] to ${EXECUTABLE_OUTPUT_PATH}")
    message("=================================================================================")
endif ()