...
message(">>>> Current project is [ortcv_tiny_yolov3] in : ${CMAKE_CURRENT_SOURCE_DIR}")
...
set(ORTCV_TINY_YOLOV3_SRCS
        cv/test_ortcv_tiny_yolov3.cpp
        ${LITEHUB_ROOT_DIR}/ort/cv/tiny_yolov3.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_utils.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_handler.cpp
        )

add_executable(ortcv_tiny_yolov3 ${ORTCV_TINY_YOLOV3_SRCS})
target_link_libraries(ortcv_tiny_yolov3 onnxruntime ${OpenCV_LIBS})
...
if (LITEHUB_COPY_BUILD)
    ...
    message("=================================================================================")
    message("output binary [app: ortcv_tiny_yolov3] to ${EXECUTABLE_OUTPUT_PATH}")
    message("=================================================================================")
endif ()