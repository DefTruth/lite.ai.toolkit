...
message(">>>> Current project is [ortcv_vgg16_gender] in : ${CMAKE_CURRENT_SOURCE_DIR}")
...
set(ORTCV_FSANET_SRCS
        cv/test_ortcv_vgg16_gender.cpp
        ${LITEHUB_ROOT_DIR}/ort/cv/vgg16_gender.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_utils.cpp
        ${LITEHUB_ROOT_DIR}/ort/core/ort_handler.cpp
        )

add_executable(ortcv_vgg16_gender ${ORTCV_FSANET_SRCS})
...
if (LITEHUB_COPY_BUILD)
    ...
    message("=================================================================================")
    message("output binary [app: ortcv_vgg16_gender] to ${EXECUTABLE_OUTPUT_PATH}")
    message("=================================================================================")
endif ()