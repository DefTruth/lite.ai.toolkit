...
void MNNFaceBoxes::detect(const cv::Mat &mat, std::vector<types::Boxf> &detected_boxes,
...
void MNNFaceBoxes::generate_bboxes(std::vector<types::Boxf> &bbox_collection,
...
void MNNFaceBoxes::nms(std::vector<types::Boxf> &input, std::vector<types::Boxf> &output,
