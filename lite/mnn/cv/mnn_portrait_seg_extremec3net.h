...
namespace mnncv
{
  class LITE_EXPORTS MNNPortraitSegExtremeC3Net : public BasicMNNHandler
  {
  public:
    explicit MNNPortraitSegExtremeC3Net(const std::string &_mnn_path, unsigned int _num_threads = 1); //
