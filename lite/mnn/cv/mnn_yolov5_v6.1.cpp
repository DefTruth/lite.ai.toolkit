...
#include "mnn_yolov5_v6.1.h"
#include "lite/utils.h"

using mnncv::MNNYoloV5_V_6_1;

MNNYoloV5_V_6_1::MNNYoloV5_V_6_1(const std::string &_mnn_path, unsigned int _num_threads) :
    BasicMNNHandler(_mnn_path, _num_threads)
{
  initialize_pretreat();
}

void MNNYoloV5_V_6_1::initialize_pretreat()
{
...
inline void MNNYoloV5_V_6_1::transform(const cv::Mat &mat_rs)
{
  // normalize & HWC -> CHW & BGR -> RGB
  pretreat->convert(mat_rs.data, input_width, input_height, mat_rs.step[0], input_tensor);
}

void MNNYoloV5_V_6_1::resize_unscale(const cv::Mat &mat, cv::Mat &mat_rs,
...
void MNNYoloV5_V_6_1::detect(const cv::Mat &mat, std::vector<types::Boxf> &detected_boxes,
...
void MNNYoloV5_V_6_1::generate_bboxes(const YoloV5ScaleParams &scale_params,
                                      std::vector<types::Boxf> &bbox_collection,
...
void MNNYoloV5_V_6_1::nms(std::vector<types::Boxf> &input, std::vector<types::Boxf> &output,
