...
#include "mnn_yolov6.h"
#include "lite/utils.h"

using mnncv::MNNYOLOv6;

MNNYOLOv6::MNNYOLOv6(const std::string &_mnn_path, unsigned int _num_threads) :
    BasicMNNHandler(_mnn_path, _num_threads)
{
  initialize_pretreat();
}

void MNNYOLOv6::initialize_pretreat()
{
...
void MNNYOLOv6::transform(const cv::Mat &mat_rs)
{
...
// letterbox
void MNNYOLOv6::resize_unscale(const cv::Mat &mat, cv::Mat &mat_rs,
...
void MNNYOLOv6::detect(const cv::Mat &mat, std::vector<types::Boxf> &detected_boxes,
...
void MNNYOLOv6::generate_anchors(const int target_height,
...
void MNNYOLOv6::generate_bboxes(const YOLOv6ScaleParams &scale_params,
                                std::vector<types::Boxf> &bbox_collection,
...
void MNNYOLOv6::nms(std::vector<types::Boxf> &input, std::vector<types::Boxf> &output,
