...
#include "ncnn_deeplabv3_resnet101.h"

using ncnncv::NCNNDeepLabV3ResNet101;

NCNNDeepLabV3ResNet101::NCNNDeepLabV3ResNet101(
...
void NCNNDeepLabV3ResNet101::transform(const cv::Mat &mat, ncnn::Mat &in)
{
...
void NCNNDeepLabV3ResNet101::detect(const cv::Mat &mat, types::SegmentContent &content)
{
  if (mat.empty()) return;
  // 1. make input tensor
  ncnn::Mat input;
