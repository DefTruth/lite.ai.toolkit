...
#include "ncnn_densenet.h"
#include "lite/utils.h"

using ncnncv::NCNNDenseNet;

NCNNDenseNet::NCNNDenseNet(const std::string &_param_path,
...
void NCNNDenseNet::transform(const cv::Mat &mat, ncnn::Mat &in)
{
  cv::Mat mat_rs;
...
void NCNNDenseNet::detect(const cv::Mat &mat, types::ImageNetContent &content, unsigned int top_k)
{
  if (mat.empty()) return;
