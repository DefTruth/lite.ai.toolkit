...
#include "ncnn_efficient_emotion7.h"
#include "lite/utils.h"

using ncnncv::NCNNEfficientEmotion7;

NCNNEfficientEmotion7::NCNNEfficientEmotion7(const std::string &_param_path,
...
void NCNNEfficientEmotion7::transform(const cv::Mat &mat, ncnn::Mat &in)
{
  cv::Mat mat_rs;
...
void NCNNEfficientEmotion7::detect(const cv::Mat &mat, types::Emotions &emotions)
{
  if (mat.empty()) return;
  ...
  extractor.extract("logits", emotion_logits); // c=1,h=1,w=7
