...
#include "ncnn_faceboxes.h"
#include "lite/utils.h"

using ncnncv::NCNNFaceBoxes;

NCNNFaceBoxes::NCNNFaceBoxes(const std::string &_param_path,
...
void NCNNFaceBoxes::transform(const cv::Mat &mat, ncnn::Mat &in)
{
  cv::Mat mat_rs;
...
void NCNNFaceBoxes::detect(const cv::Mat &mat, std::vector<types::Boxf> &detected_boxes,
...
void NCNNFaceBoxes::generate_anchors(const int target_height, const int target_width,
...
void NCNNFaceBoxes::generate_bboxes(std::vector<types::Boxf> &bbox_collection,
...
void NCNNFaceBoxes::nms(std::vector<types::Boxf> &input, std::vector<types::Boxf> &output,
