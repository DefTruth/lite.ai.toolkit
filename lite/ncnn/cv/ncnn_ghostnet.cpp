...
#include "ncnn_ghostnet.h"
#include "lite/utils.h"

using ncnncv::NCNNGhostNet;

NCNNGhostNet::NCNNGhostNet(const std::string &_param_path,
...
void NCNNGhostNet::transform(const cv::Mat &mat, ncnn::Mat &in)
{
  cv::Mat mat_rs;
...
void NCNNGhostNet::detect(const cv::Mat &mat, types::ImageNetContent &content, unsigned int top_k)
{
  if (mat.empty()) return;
