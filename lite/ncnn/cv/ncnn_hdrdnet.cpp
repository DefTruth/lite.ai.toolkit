...
#include "ncnn_hdrdnet.h"
#include "lite/utils.h"

using ncnncv::NCNNHdrDNet;

NCNNHdrDNet::NCNNHdrDNet(const std::string &_param_path,
...
void NCNNHdrDNet::transform(const cv::Mat &mat, ncnn::Mat &in)
{
  cv::Mat mat_rs;
...
void NCNNHdrDNet::detect(const cv::Mat &mat, types::ImageNetContent &content, unsigned int top_k)
{
  if (mat.empty()) return;
