...
#include "ncnn_ibnnet.h"
#include "lite/utils.h"

using ncnncv::NCNNIBNNet;

NCNNIBNNet::NCNNIBNNet(const std::string &_param_path,
...
void NCNNIBNNet::transform(const cv::Mat &mat, ncnn::Mat &in)
{
  cv::Mat mat_rs;
...
void NCNNIBNNet::detect(const cv::Mat &mat, types::ImageNetContent &content, unsigned int top_k)
{
  if (mat.empty()) return;
