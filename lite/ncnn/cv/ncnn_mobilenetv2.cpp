...
#include "ncnn_mobilenetv2.h"
#include "lite/utils.h"

using ncnncv::NCNNMobileNetV2;

NCNNMobileNetV2::NCNNMobileNetV2(const std::string &_param_path,
...
void NCNNMobileNetV2::transform(const cv::Mat &mat, ncnn::Mat &in)
{
  cv::Mat mat_rs;
...
void NCNNMobileNetV2::detect(const cv::Mat &mat, types::ImageNetContent &content, unsigned int top_k)
{
  if (mat.empty()) return;
