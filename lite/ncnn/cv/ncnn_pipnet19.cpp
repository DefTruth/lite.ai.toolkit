...
#include "ncnn_pipnet19.h"

using ncnncv::NCNNPIPNet19;

NCNNPIPNet19::NCNNPIPNet19(const std::string &_param_path,
...
void NCNNPIPNet19::transform(const cv::Mat &mat, ncnn::Mat &in)
{
  cv::Mat mat_rs;
...
void NCNNPIPNet19::detect(const cv::Mat &mat, types::Landmarks &landmarks)
{
  if (mat.empty()) return;
...
void NCNNPIPNet19::generate_landmarks(types::Landmarks &landmarks,
                                      ncnn::Extractor &extractor,
                                      float img_height, float img_width)
{
  ncnn::Mat outputs_cls, outputs_x, outputs_y, outputs_nb_x, outputs_nb_y;
  extractor.extract("outputs_cls", outputs_cls); // (19,8,8)
  extractor.extract("outputs_x", outputs_x); // (19,8,8)
  extractor.extract("outputs_y", outputs_y); // (19,8,8)
  extractor.extract("outputs_nb_x", outputs_nb_x); // (19*10,8,8)
  extractor.extract("outputs_nb_y", outputs_nb_y); // (19*10,8,8)
