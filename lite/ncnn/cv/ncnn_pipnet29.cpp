...
#include "ncnn_pipnet29.h"

using ncnncv::NCNNPIPNet29;

NCNNPIPNet29::NCNNPIPNet29(const std::string &_param_path,
...
void NCNNPIPNet29::transform(const cv::Mat &mat, ncnn::Mat &in)
{
  cv::Mat mat_rs;
...
void NCNNPIPNet29::detect(const cv::Mat &mat, types::Landmarks &landmarks)
{
  if (mat.empty()) return;
...
void NCNNPIPNet29::generate_landmarks(types::Landmarks &landmarks,
                                      ncnn::Extractor &extractor,
                                      float img_height, float img_width)
{
  ncnn::Mat outputs_cls, outputs_x, outputs_y, outputs_nb_x, outputs_nb_y;
  extractor.extract("outputs_cls", outputs_cls); // (29,8,8)
  extractor.extract("outputs_x", outputs_x); // (29,8,8)
  extractor.extract("outputs_y", outputs_y); // (29,8,8)
  extractor.extract("outputs_nb_x", outputs_nb_x); // (29*10,8,8)
  extractor.extract("outputs_nb_y", outputs_nb_y); // (29*10,8,8)
