                                      ...
                                      float img_height, float img_width)
{
  ...
  extractor.extract("outputs_cls", outputs_cls); // (98,8,8)
  extractor.extract("outputs_x", outputs_x); // (98,8,8)
  extractor.extract("outputs_y", outputs_y); // (98,8,8)
  extractor.extract("outputs_nb_x", outputs_nb_x); // (98*10,8,8)
  extractor.extract("outputs_nb_y", outputs_nb_y); // (98*10,8,8)
