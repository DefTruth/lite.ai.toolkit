...
#include "ncnn_resnext.h"
#include "lite/utils.h"

using ncnncv::NCNNResNeXt;

NCNNResNeXt::NCNNResNeXt(const std::string &_param_path,
...
void NCNNResNeXt::transform(const cv::Mat &mat, ncnn::Mat &in)
{
  cv::Mat mat_rs;
...
void NCNNResNeXt::detect(const cv::Mat &mat, types::ImageNetContent &content, unsigned int top_k)
{
  if (mat.empty()) return;
