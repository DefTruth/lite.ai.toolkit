...
Ort::Value EfficientDet::transform(const cv::Mat &mat)
{
...
void EfficientDet::detect(const cv::Mat &mat, std::vector<types::Boxf> &detected_boxes,
...
void EfficientDet::generate_bboxes(std::vector<types::Boxf> &bbox_collection,
