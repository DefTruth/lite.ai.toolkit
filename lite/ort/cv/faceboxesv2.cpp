...
#include "faceboxesv2.h"
#include "lite/ort/core/ort_utils.h"
#include "lite/utils.h"

using ortcv::FaceBoxesV2;

Ort::Value FaceBoxesV2::transform(const cv::Mat &mat)
{
  cv::Mat canvas;
...
void FaceBoxesV2::detect(const cv::Mat &mat, std::vector<types::Boxf> &detected_boxes,
...
void FaceBoxesV2::generate_anchors(const int target_height,
...
void FaceBoxesV2::generate_bboxes(std::vector<types::Boxf> &bbox_collection,
...
void FaceBoxesV2::nms(std::vector<types::Boxf> &input, std::vector<types::Boxf> &output,
