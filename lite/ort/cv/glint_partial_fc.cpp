...
#include "glint_partial_fc.h"
#include "lite/ort/core/ort_utils.h"

using ortcv::GlintPartialFC;

Ort::Value GlintPartialFC::transform(const cv::Mat &mat)
{
  cv::Mat canvas;
...
void GlintPartialFC::detect(const cv::Mat &mat, types::FaceContent &face_content)
{
  if (mat.empty()) return;
  // 1. make input tensor
