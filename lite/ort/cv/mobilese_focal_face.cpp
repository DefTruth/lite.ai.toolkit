...
#include "mobilese_focal_face.h"
#include "lite/ort/core/ort_utils.h"

using ortcv::MobileSEFocalFace;

Ort::Value MobileSEFocalFace::transform(const cv::Mat &mat)
{
...
void MobileSEFocalFace::detect(const cv::Mat &mat, types::FaceContent &face_content)
{
  if (mat.empty()) return;
  // 1. make input tensor
  ...
  auto embedding_dims = output_node_dims.at(0); // (1,256,1,1)
