...
//
#include "nanodet_efficientnet_lite.h"
#include "lite/ort/core/ort_utils.h"
#include "lite/utils.h"

using ortcv::NanoDetEfficientNetLite;

void NanoDetEfficientNetLite::resize_unscale(const cv::Mat &mat, cv::Mat &mat_rs,
...
Ort::Value NanoDetEfficientNetLite::transform(const cv::Mat &mat_rs)
{
...
void NanoDetEfficientNetLite::detect(
...
void NanoDetEfficientNetLite::generate_points(unsigned int target_height, unsigned int target_width)
{
...
void NanoDetEfficientNetLite::generate_bboxes(const NanoLiteScaleParams &scale_params,
                                              std::vector<types::Boxf> &bbox_collection,
...
void NanoDetEfficientNetLite::generate_bboxes_single_stride(const NanoLiteScaleParams &scale_params,
                                                            Ort::Value &cls_pred,
                                                            Ort::Value &dis_pred,
                                                            unsigned int stride,
...
void NanoDetEfficientNetLite::nms(std::vector<types::Boxf> &input, std::vector<types::Boxf> &output,
