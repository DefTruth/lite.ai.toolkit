...
#include "tencent_cifp_face.h"
#include "lite/ort/core/ort_utils.h"

using ortcv::TencentCifpFace;

Ort::Value TencentCifpFace::transform(const cv::Mat &mat)
{
...
void TencentCifpFace::detect(const cv::Mat &mat, types::FaceContent &face_content)
{
  if (mat.empty()) return;
  // 1. make input tensor
