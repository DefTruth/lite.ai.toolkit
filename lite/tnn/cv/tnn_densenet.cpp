...
#include "tnn_densenet.h"
#include "lite/utils.h"

using tnncv::TNNDenseNet;

TNNDenseNet::TNNDenseNet(const std::string &_proto_path,
...
void TNNDenseNet::transform(const cv::Mat &mat_rs)
{
...
void TNNDenseNet::detect(const cv::Mat &mat, types::ImageNetContent &content, unsigned int top_k)
{
  if (mat.empty()) return;
