...
#include "tnn_efficient_emotion8.h"
#include "lite/utils.h"

using tnncv::TNNEfficientEmotion8;

TNNEfficientEmotion8::TNNEfficientEmotion8(const std::string &_proto_path,
...
void TNNEfficientEmotion8::transform(const cv::Mat &mat_rs)
{
...
void TNNEfficientEmotion8::detect(const cv::Mat &mat, types::Emotions &emotions)
{
  if (mat.empty()) return;
