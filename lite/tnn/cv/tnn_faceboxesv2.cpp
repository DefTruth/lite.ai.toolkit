...
#include "tnn_faceboxesv2.h"
#include "lite/utils.h"

using tnncv::TNNFaceBoxesV2;

TNNFaceBoxesV2::TNNFaceBoxesV2(const std::string &_proto_path,
...
void TNNFaceBoxesV2::transform(const cv::Mat &mat_rs)
{
  //  cv::Mat mat_rs;
...
void TNNFaceBoxesV2::detect(const cv::Mat &mat, std::vector<types::Boxf> &detected_boxes,
                                     ...
                                     float img_width)
{
  ...
  status_bboxes = _instance->GetOutputMat(bboxes, cvt_param, "loc", output_device_type);
...
void TNNFaceBoxesV2::nms(std::vector<types::Boxf> &input, std::vector<types::Boxf> &output,
