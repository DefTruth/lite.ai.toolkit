...
#include "tnn_fcn_resnet101.h"
#include "lite/utils.h"

using tnncv::TNNFCNResNet101;

TNNFCNResNet101::TNNFCNResNet101(
...
void TNNFCNResNet101::initialize_instance()
{
...
void TNNFCNResNet101::print_debug_string()
{
...
void TNNFCNResNet101::detect(const cv::Mat &mat, types::SegmentContent &content)
{
  if (mat.empty()) return;
  const int img_width = mat.cols;
  const int img_height = mat.rows;
