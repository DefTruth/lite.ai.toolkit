...
#include "tnn_ghostnet.h"
#include "lite/utils.h"

using tnncv::TNNGhostNet;

TNNGhostNet::TNNGhostNet(const std::string &_proto_path,
...
void TNNGhostNet::transform(const cv::Mat &mat_rs)
{
...
void TNNGhostNet::detect(const cv::Mat &mat, types::ImageNetContent &content, unsigned int top_k)
{
  if (mat.empty()) return;
