...
#include "tnn_hdrdnet.h"
#include "lite/utils.h"

using tnncv::TNNHdrDNet;

TNNHdrDNet::TNNHdrDNet(const std::string &_proto_path,
...
void TNNHdrDNet::transform(const cv::Mat &mat_rs)
{
...
void TNNHdrDNet::detect(const cv::Mat &mat, types::ImageNetContent &content, unsigned int top_k)
{
  if (mat.empty()) return;
