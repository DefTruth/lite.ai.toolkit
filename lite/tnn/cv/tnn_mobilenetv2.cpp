...
#include "tnn_mobilenetv2.h"
#include "lite/utils.h"

using tnncv::TNNMobileNetV2;

TNNMobileNetV2::TNNMobileNetV2(const std::string &_proto_path,
...
void TNNMobileNetV2::transform(const cv::Mat &mat_rs)
{
...
void TNNMobileNetV2::detect(const cv::Mat &mat, types::ImageNetContent &content, unsigned int top_k)
{
  if (mat.empty()) return;
  ...
  status = instance->GetOutputMat(logits_mat, cvt_param, "logits", output_device_type);
