...
#include "tnn_mobilenetv2_68.h"

using tnncv::TNNMobileNetV268;

TNNMobileNetV268::TNNMobileNetV268(const std::string &_proto_path,
...
void TNNMobileNetV268::transform(const cv::Mat &mat_rs)
{
  // push into input_mat
...
void TNNMobileNetV268::detect(const cv::Mat &mat, types::Landmarks &landmarks)
{
  if (mat.empty()) return;
