...
#include "tnn_mobilenetv2_se_68.h"

using tnncv::TNNMobileNetV2SE68;

TNNMobileNetV2SE68::TNNMobileNetV2SE68(const std::string &_proto_path,
...
void TNNMobileNetV2SE68::transform(const cv::Mat &mat_rs)
{
  // push into input_mat
...
void TNNMobileNetV2SE68::detect(const cv::Mat &mat, types::Landmarks &landmarks)
{
  if (mat.empty()) return;
  ...
  std::shared_ptr<tnn::Mat> landmarks_norm; // (1,68*2=136)
