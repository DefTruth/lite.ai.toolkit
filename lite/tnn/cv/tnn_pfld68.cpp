...
#include "tnn_pfld68.h"

using tnncv::TNNPFLD68;

TNNPFLD68::TNNPFLD68(const std::string &_proto_path,
...
void TNNPFLD68::detect(const cv::Mat &mat, types::Landmarks &landmarks)
{
  if (mat.empty()) return;
