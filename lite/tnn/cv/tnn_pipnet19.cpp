...
#include "tnn_pipnet19.h"

using tnncv::TNNPIPNet19;

TNNPIPNet19::TNNPIPNet19(const std::string &_proto_path,
...
void TNNPIPNet19::transform(const cv::Mat &mat_rs)
{
...
void TNNPIPNet19::detect(const cv::Mat &mat, types::Landmarks &landmarks)
{
  if (mat.empty()) return;
...
void TNNPIPNet19::generate_landmarks(types::Landmarks &landmarks,
