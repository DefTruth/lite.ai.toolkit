...
#include "tnn_pipnet29.h"

using tnncv::TNNPIPNet29;

TNNPIPNet29::TNNPIPNet29(const std::string &_proto_path,
...
void TNNPIPNet29::transform(const cv::Mat &mat_rs)
{
...
void TNNPIPNet29::detect(const cv::Mat &mat, types::Landmarks &landmarks)
{
  if (mat.empty()) return;
...
void TNNPIPNet29::generate_landmarks(types::Landmarks &landmarks,
