...
#include "tnn_pipnet68.h"

using tnncv::TNNPIPNet68;

TNNPIPNet68::TNNPIPNet68(const std::string &_proto_path,
...
void TNNPIPNet68::transform(const cv::Mat &mat_rs)
{
...
void TNNPIPNet68::detect(const cv::Mat &mat, types::Landmarks &landmarks)
{
  if (mat.empty()) return;
...
void TNNPIPNet68::generate_landmarks(types::Landmarks &landmarks,
