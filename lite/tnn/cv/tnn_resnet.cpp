...
#include "tnn_resnet.h"
#include "lite/utils.h"

using tnncv::TNNResNet;

TNNResNet::TNNResNet(const std::string &_proto_path,
...
void TNNResNet::transform(const cv::Mat &mat_rs)
{
...
void TNNResNet::detect(const cv::Mat &mat, types::ImageNetContent &content, unsigned int top_k)
{
  if (mat.empty()) return;
