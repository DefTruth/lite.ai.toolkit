...
#include "tnn_resnext.h"
#include "lite/utils.h"

using tnncv::TNNResNeXt;

TNNResNeXt::TNNResNeXt(const std::string &_proto_path,
...
void TNNResNeXt::transform(const cv::Mat &mat_rs)
{
...
void TNNResNeXt::detect(const cv::Mat &mat, types::ImageNetContent &content, unsigned int top_k)
{
  if (mat.empty()) return;
