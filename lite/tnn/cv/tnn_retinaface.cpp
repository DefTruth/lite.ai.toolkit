...
#include "tnn_retinaface.h"
#include "lite/utils.h"

using tnncv::TNNRetinaFace;

TNNRetinaFace::TNNRetinaFace(const std::string &_proto_path,
...
void TNNRetinaFace::transform(const cv::Mat &mat_rs)
{
  // push into input_mat
...
void TNNRetinaFace::detect(const cv::Mat &mat, std::vector<types::Boxf> &detected_boxes,
...
void TNNRetinaFace::generate_anchors(const int target_height, const int target_width,
...
void TNNRetinaFace::generate_bboxes(std::vector<types::Boxf> &bbox_collection,
...
void TNNRetinaFace::nms(std::vector<types::Boxf> &input, std::vector<types::Boxf> &output,
