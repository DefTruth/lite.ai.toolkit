...
#include "tnn_rexnet_emotion7.h"
#include "lite/utils.h"

using tnncv::TNNReXNetEmotion7;

TNNReXNetEmotion7::TNNReXNetEmotion7(const std::string &_proto_path,
...
void TNNReXNetEmotion7::transform(const cv::Mat &mat_rs)
{
...
void TNNReXNetEmotion7::detect(const cv::Mat &mat, types::Emotions &emotions)
{
  if (mat.empty()) return;
