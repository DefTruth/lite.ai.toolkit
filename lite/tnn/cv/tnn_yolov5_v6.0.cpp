...
#include "tnn_yolov5_v6.0.h"
#include "lite/utils.h"

using tnncv::TNNYoloV5_V_6_0;

TNNYoloV5_V_6_0::TNNYoloV5_V_6_0(const std::string &_proto_path,
...
void TNNYoloV5_V_6_0::resize_unscale(const cv::Mat &mat, cv::Mat &mat_rs,
...
void TNNYoloV5_V_6_0::detect(const cv::Mat &mat, std::vector<types::Boxf> &detected_boxes,
...
void TNNYoloV5_V_6_0::generate_bboxes(const YoloV5ScaleParams &scale_params,
                                      std::vector<types::Boxf> &bbox_collection,
                                      ...
                                      int img_width)
{
  ...
  status = _instance->GetOutputMat(pred_mat, pred_cvt_param, "output", output_device_type);
  if (status != tnn::TNN_OK)
  {
#ifdef LITETNN_DEBUG
...
void TNNYoloV5_V_6_0::nms(std::vector<types::Boxf> &input, std::vector<types::Boxf> &output,
