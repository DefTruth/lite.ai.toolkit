...
inline mnncv::types::BoundingBoxType<O1, O2>
mnncv::types::BoundingBoxType<T1, T2>::convert_type() const
{
...
template<typename T1, typename T2>
template<typename O1, typename O2>
inline typename mnncv::types::BoundingBoxType<T1, T2>::value_type
mnncv::types::BoundingBoxType<T1, T2>::iou_of(const BoundingBoxType<O1, O2> &other) const
{
...
template<typename T1, typename T2>
inline cv::Rect mnncv::types::BoundingBoxType<T1, T2>::rect() const
{
  types::__assert_type<value_type, score_type>();
...
template<typename T1, typename T2>
inline cv::Point2i mnncv::types::BoundingBoxType<T1, T2>::tl() const
{
  types::__assert_type<value_type, score_type>();
  auto boxi = this->template convert_type<int>();
...
template<typename T1, typename T2>
inline cv::Point2i mnncv::types::BoundingBoxType<T1, T2>::rb() const
{
  types::__assert_type<value_type, score_type>();
  auto boxi = this->template convert_type<int>();
...
template<typename T1, typename T2>
inline typename mnncv::types::BoundingBoxType<T1, T2>::value_type
mnncv::types::BoundingBoxType<T1, T2>::width() const
{
  types::__assert_type<value_type, score_type>();
...
template<typename T1, typename T2>
inline typename mnncv::types::BoundingBoxType<T1, T2>::value_type
mnncv::types::BoundingBoxType<T1, T2>::height() const
{
  types::__assert_type<value_type, score_type>();
...
template<typename T1, typename T2>
inline typename mnncv::types::BoundingBoxType<T1, T2>::value_type
mnncv::types::BoundingBoxType<T1, T2>::area() const
{
  types::__assert_type<value_type, score_type>();
