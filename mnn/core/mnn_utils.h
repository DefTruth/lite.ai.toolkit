...
template<typename T>
std::vector<T> mnncv::utils::math::softmax(const std::vector<T> &logits, unsigned int &max_id)
{
  types::__assert_type<T>();
...
template<typename T>
std::vector<unsigned int> mnncv::utils::math::argsort(const std::vector<T> &arr)
{
  types::__assert_type<T>();
  if (arr.empty()) return {};
...
template<typename T>
std::vector<unsigned int> mnncv::utils::math::argsort(const T *arr, unsigned int _size)
{
  types::__assert_type<T>();
...
template<typename T>
T mnncv::utils::math::cosine_similarity(const std::vector<T> &a, const std::vector<T> &b)
{
  types::__assert_type<T>();
