...
namespace ortcv
{
  ...
  class LITEHUB_EXPORTS SphereFace;                 // [38] reference: https://github.com/wy1iu/sphereface
  ...
  class LITEHUB_EXPORTS CurricularFace;             // [42] reference: https://github.com/HuangYG123/CurricularFace
}
