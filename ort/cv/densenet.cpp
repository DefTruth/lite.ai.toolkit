...
using ortcv::DenseNet;

Ort::Value DenseNet::transform(const cv::Mat &mat)
{
...
void DenseNet::detect(const cv::Mat &mat, types::ImageNetContent &content, unsigned int top_k)
{
  if (mat.empty()) return;
  // 1. make input tensor
