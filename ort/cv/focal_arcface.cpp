...
#include "focal_arcface.h"
#include "ort/core/ort_utils.h"

using ortcv::FocalArcFace;

Ort::Value FocalArcFace::transform(const cv::Mat &mat)
{
...
void FocalArcFace::detect(const cv::Mat &mat, types::FaceContent &face_content)
{
  if (mat.empty()) return;
  // 1. make input tensor
