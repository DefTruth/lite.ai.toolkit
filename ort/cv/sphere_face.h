...
#ifndef LITEHUB_ORT_CV_SPHERE_FACE_H
#define LITEHUB_ORT_CV_SPHERE_FACE_H

#include "ort/core/ort_core.h"

namespace ortcv
{
  class LITEHUB_EXPORTS SphereFace : public BasicOrtHandler
  {
  public:
...
#endif //LITEHUB_ORT_CV_SPHERE_FACE_H
