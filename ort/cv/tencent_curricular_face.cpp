...
#include "tencent_curricular_face.h"
#include "ort/core/ort_utils.h"

using ortcv::TencentCurricularFace;

Ort::Value TencentCurricularFace::transform(const cv::Mat &mat)
{
...
void TencentCurricularFace::detect(const cv::Mat &mat, types::FaceContent &face_content)
{
  if (mat.empty()) return;
  // 1. make input tensor
