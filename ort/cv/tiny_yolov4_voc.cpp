...
Ort::Value TinyYoloV4VOC::transform(const cv::Mat &mat)
{
...
void TinyYoloV4VOC::detect(const cv::Mat &mat, std::vector<types::Boxf> &detected_boxes,
...
void TinyYoloV4VOC::generate_bboxes(std::vector<types::Boxf> &bbox_collection,
